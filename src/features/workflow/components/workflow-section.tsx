              ...
              {steps.map((step, index) => (
                <div key={index} className="group relative flex gap-8">
                  <div className="relative shrink-0">
                    <div
                      className={`relative z-10 flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-200 bg-white shadow-sm transition-transform duration-300 group-hover:scale-110`}
                    >
                      <div
                ...
                <div className="absolute -right-12 bottom-20 z-30 animate-bounce duration-3000">
                  <div className="flex items-center gap-3 rounded-2xl border border-white/50 bg-white/90 p-4 pr-6 shadow-xl shadow-slate-200/50 backdrop-blur-xl">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-slate-900">Query Executed</p>
                    </div>
                  </div>
                </div>
