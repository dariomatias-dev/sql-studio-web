  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        <div className="shadow-brand/5 mb-8 inline-flex cursor-default items-center gap-x-3 rounded-full border border-white/10 bg-zinc-900/40 p-1.5 pr-4 pl-2 shadow-lg ring-1 ring-white/5 backdrop-blur-xl transition-all hover:border-white/20 hover:bg-zinc-900/60 hover:ring-white/10">
