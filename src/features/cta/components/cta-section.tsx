  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 h-full w-full">
        ...
        <div className="animate-pulse-slow bg-brand/10 absolute top-0 left-1/2 h-64 w-full max-w-3xl -translate-x-1/2 rounded-full opacity-50 mix-blend-screen blur-[100px]" />
      ...
      <div className="via-brand/20 absolute top-0 right-0 left-0 h-px bg-linear-to-r from-transparent to-transparent" />

      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        <Reveal className="shadow-brand/5 mb-8 inline-flex cursor-default items-center gap-x-3 rounded-full border border-white/10 bg-zinc-900/40 p-1.5 pr-4 pl-2 shadow-lg ring-1 ring-white/5 backdrop-blur-xl transition-all hover:border-white/20 hover:bg-zinc-900/60 hover:ring-white/10">
          <span className="bg-brand/10 text-brand ring-brand/20 flex items-center justify-center rounded-full px-2.5 py-0.5 text-[10px] font-bold tracking-wide uppercase ring-1 ring-inset">
            {APP_RELEASE_LABEL}
          </span>
        ...
        <Reveal delay={300} className="flex flex-col items-center justify-center gap-8">
          <DownloadButton />
