...
[docs/architecture.pt-BR.md](docs/architecture.pt-BR.md) pras regras de dependência e
...
[docs/security.pt-BR.md](docs/security.pt-BR.md) para como relatar de forma privada.
